...
cfg.emotes = {
  ["Mains en l'air"] = { -- handsup state, use clear to lower hands
    true,
  ...
  ["S'asseoir (support)"] = {false, {task="PROP_HUMAN_SEAT_CHAIR_MP_PLAYER"}, false},
--  ["Cop"] = {false, {task="WORLD_HUMAN_COP_IDLES"}, false},
  ...
  ["Bourré"] = {false, {task="WORLD_HUMAN_DRINKING"}, false},
...
-- ["Hiker"] = {false, {task="WORLD_HUMAN_HIKER_STANDING"}, false},
  ...
  ["S'asseoir"] = {false, {task="WORLD_HUMAN_PICNIC"}, false},
  ["Hoe"] = {false, {task="WORLD_HUMAN_PROSTITUTE_HIGH_CLASS"}, false},
  ["Hoe2"] = {false, {task="WORLD_HUMAN_PROSTITUTE_LOW_CLASS"}, false},
  ["Pompes"] = {false, {task="WORLD_HUMAN_PUSH_UPS"}, false},
  ["Abdos"] = {false, {task="WORLD_HUMAN_SIT_UPS"}, false},
