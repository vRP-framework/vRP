  ...
  vehicle = {
	...
	custom = {
		...
		plate_txt = {
			...
			description = "Установить пользовательский текст номерного знака транспортного средства.",
			prompt = "Новый текст номерного знака автомобиля (максимум 8 символов):",
			Completed = "Текст таблички изменен на ~g~{1}"
		}
	},
  gunshop = {
    title = "Оружейная ({1})",
